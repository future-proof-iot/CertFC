...
Definition f : encodeCompilableSymbolType (Some M) (MkCompilableSymbolType Args (Some Res)) := getMemRegion_block_size.
...
Lemma correct_function_block_size : correct_function p Args Res f fn match_mem match_arg_list match_res.
Proof.
  constructor.
  - unfold Args; intro; car_cdr; simpl;
    ...
    destruct c as (v,v'); unfold block_size_correct in *; simpl in H;
    intuition subst; clear H2; destruct H1 ; subst; destruct H as [ofs [vsize [H [H1 H2]]]].
    simpl; do 3 eexists; repeat split; unfold step2.
