...
Require Import Clightlogic MatchState.
...
Definition res : Type := unit.
  ...
  Definition match_mem : stateM -> Memory.Mem.mem -> Prop := fun stM m => match_meminj_state state_block inject_id stM m.


  Definition val_correct (x:int64_t) (v: val) (m: Memory.Mem.mem) :=
    Vlong x = v.

  (* [match_arg] relates the Coq arguments and the C arguments *)
  Definition match_arg_list : DList.t (fun x => x -> val -> Memory.Mem.mem -> Prop) args := DList.DCons val_correct (DList.DNil _).
