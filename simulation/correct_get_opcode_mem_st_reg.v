...
Section Get_opcode_mem_st_reg.
  ...
  Definition match_res : res -> Inv := fun x  => StateLess (opcode_mem_st_reg_correct x).

  Instance correct_function_get_opcode_mem_st_reg : forall a, correct_function p args res f fn ModNothing true match_state match_arg_list match_res a.
  Proof.
