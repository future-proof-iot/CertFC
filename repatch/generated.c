...
{
  return (unsigned long long) ins$122;
}
...
{
  return (unsigned int) (x$150 + (unsigned long long) (unsigned int) ofs);
}
...
void step_opcode_alu32(unsigned int dst32, unsigned int src32$232, unsigned int dst$234, unsigned char op$236)
{
  ...
  switch (opcode_alu32) {
    case 0:
      upd_reg(dst$234, (unsigned long long) (dst32 + src32$232));
      upd_flag(0);
      return;
    case 16:
      upd_reg(dst$234, (unsigned long long) (dst32 - src32$232));
    ...
    case 128:
      upd_reg(dst$234, (unsigned long long) -dst32);
      upd_flag(0);
      return;
    case 144:
      if (src32$232 != 0U) {
    ...
    case 192:
      if (src32$232 < 32U) {
        upd_reg(dst$234, (unsigned long long) ((int) dst32 >> src32$232));
        upd_flag(0);
        return;
      } else {
        upd_flag(-10);
