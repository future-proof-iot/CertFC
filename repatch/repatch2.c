...
const char old_words[][100] = {
	...
	"eval_mem_regions()",
	"step_opcode_alu64(unsigned",
	"step_opcode_alu64(dst",
	"step_opcode_alu32(unsigned",
	"step_opcode_alu32(dst",
	"step_opcode_branch(unsigned",
	"step_opcode_branch(pc",
	"step_opcode_mem_ld_imm(unsigned",
	"step_opcode_mem_ld_imm(pc",
	"void step_opcode_mem_ld_reg(",
	
	"step_opcode_mem_ld_reg(pc",
	"void step_opcode_mem_st_imm(",
	"step_opcode_mem_st_imm(pc",
	"void step_opcode_mem_st_reg(",
	"step_opcode_mem_st_reg(pc",
	"load_mem(1",
	"load_mem(2",
	"load_mem(4",
	"load_mem(8",
	...
	"store_mem_reg(4",
	"store_mem_reg(8",
	"unsigned long long check_mem_aux(",
	...
	"unsigned long long get_addl(",
	"unsigned long long get_subl(",
	"_Bool is_well_chunk_bool(",
	"unsigned long long check_mem_aux2(",
...
const char new_words[][100] = {
	...
	"eval_mem_regions(st)",
	"step_opcode_alu64(struct bpf_state* st, unsigned",
	"step_opcode_alu64(st, dst",
	"step_opcode_alu32(struct bpf_state* st, unsigned",
	"step_opcode_alu32(st, pc",
	"step_opcode_branch(struct bpf_state* st, unsigned",
	"step_opcode_branch(st, pc",
	"step_opcode_mem_ld_imm(struct bpf_state* st, unsigned",
	"step_opcode_mem_ld_imm(st, pc",
	"void step_opcode_mem_ld_reg(struct bpf_state* st, ",
	
	"step_opcode_mem_ld_reg(st, pc",
	"void step_opcode_mem_st_imm(struct bpf_state* st, ",
	"step_opcode_mem_st_imm(st, pc",
	"void step_opcode_mem_st_reg(struct bpf_state* st, ",
	"step_opcode_mem_st_reg(st, pc",
	"load_mem(st, 1",
	"load_mem(st, 2",
	"load_mem(st, 4",
	"load_mem(st, 8",
	...
	"store_mem_reg(st, 4",
	"store_mem_reg(st, 8",
	"unsigned long long check_mem_aux(struct bpf_state* st, ",
	"return check_mem_aux(st, ",
	"unsigned long long check_mem(struct bpf_state* st, ",
	...
	"static unsigned long long get_addl(",
	"static unsigned long long get_subl(",
	"static _Bool is_well_chunk_bool(",
	"static unsigned long long check_mem_aux2(",
